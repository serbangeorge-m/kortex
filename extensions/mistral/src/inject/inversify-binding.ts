...
import { ExtensionContextSymbol, MistralProviderSymbol, SecretStorageSymbol } from '/@/inject/symbol';
...
export class InversifyBinding {
  ...
  public async initBindings(): Promise<Container> {
    ...
    this.#container.bind(MistralProviderSymbol).toConstantValue(this.#provider);
    ...
    await this.#container.getAsync(MistralSkillsManager);
    await this.#container.getAsync(MistralInferenceManager);
