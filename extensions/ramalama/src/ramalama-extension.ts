...
import { env, type ExtensionContext, extensions, provider } from '@kortex-app/api';
...
export class RamaLamaExtension {
  ...
  async activate(): Promise<void> {
    ...
    const containerExtension = extensions.getExtension<ContainerExtensionAPI>(KORTEX_CONTAINER_EXTENSION_ID);
