...
<nav
  ...
  <div class="h-full overflow-y-auto" style="margin-bottom:auto">
    {#each [{ title: 'Resources', href: '/preferences/resources', visible: true }, { title: 'Proxy', href: '/preferences/proxies', visible: true }, { title: 'MCP Registries', href: '/preferences/mcp-registries', visible: true }] as navItem, index (index)}
      {#if navItem.visible}
